<header id="masthead" class="site-header headertwo sticky-<?php echo esc_attr( get_theme_mod('spark_multipurpose_menu_sticky', 'disable') ); ?> ovarnav-<?php echo esc_attr( get_theme_mod('spark_multipurpose_menu_absolute', 'disable') ); ?>">
	<?php
				...
				<div class="inner-row d-flex">
					<div class="site-branding <?php echo esc_attr( $logo_alignment_class ); ?>">
						...
						<div class="desktop-hide tablet-show">
							<?php do_action('spark_multipurpose_nav_buttons'); ?>
						</div>
					</div>
